...
import HomeSectionCarosel from "../../components/HomeSectionCaruosel/HomeSectionCarosel";
...
const HomePage = () => {
    return (
        <div>
            ...
            <div className="space-y10 py-10 flex flex-col justify-center px-5 lg:px-10">
